<?php
/**
 * Mobile Drawer - Sliding sidebar for mobile
 * 
 * Optional variables:
 * - $drawerId: Unique drawer ID (default: 'mobile-drawer')
 * - $drawerTitle: Drawer title
 * - $drawerIcon: Title icon
 * - $drawerIconColor: Icon color (default: 'text-[#23AAC5]')
 * - $drawerContent: Drawer HTML content (if not using slot)
 * - $drawerShowNewButton: Whether to show "New" button (default: false)
 * - $drawerNewButtonId: New button ID
 * - $drawerNewButtonText: New button text
 */
